...
const checkPass = value => strongRegex.test(value) ? undefined : 'Password must include: at least one uppercase letter, one lowercase letter, one number and one symbol (*.!@#$%^&(){}[\\]:;<>,.?\\/~_+-=|) and have at least 8 characters'
